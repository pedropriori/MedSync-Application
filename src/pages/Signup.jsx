...
const SignUp = () => {
  ...
  const [priviewURL, setPreviewURL] = useState("")
    ...
    <section className="px-5 xl:px-0">
      <div className="max-w-[1170px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          {/* === image box ==== */}
          <div className="hidden lg:block bg-primaryBgColor rounded-l-lg">
            <figure className='rounded-l-lg'>
              <img src={signupImg} alt="sign-up" className='w-full rounded-l-lg' />
            </figure>
          </div>
          ...
          <div className='rounded-l-lg lg:pl-16 py-10'>
            ...
            <form onSubmit={submitHandler}>
              ...
              <p className="mt-5 text-textColor text-center">
                Já possui uma conta? 
                <Link to="/login" className="text-primaryBgColor font-medium ml-1">
                  Login
                </Link>
              </p>
            </form>
